...
class CombinedNet(nn.Module):
    def __init__(self, num_classes=100, dropout_rate=0.4):
        ...
        self.attblock1 = VisualAttentionBlock(64, 64)
        self.attblock2 = VisualAttentionBlock(128, 128)
        self.attblock3 = VisualAttentionBlock(256, 256)
    ...
    def forward(self, x):
        ...
        # Visual Attention Blocks
        out = self.attblock1(out)
        out = self.dropout(out)
        out = self.attblock2(out)
        out = self.dropout(out)
        out = self.attblock3(out)
        out = self.dropout(out)
