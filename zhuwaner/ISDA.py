...
class ISDALoss(nn.Module):
    ...
    def forward(self, linear, features, y, target_x, ratio):

        self.estimator.update_CV(features.detach(), target_x)

        isda_aug_y = self.isda_aug(linear, features, y, target_x, self.estimator.CoVariance.detach(), ratio)

        loss = F.cross_entropy(isda_aug_y, target_x)
