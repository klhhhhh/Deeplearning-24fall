...
class SE_Block(nn.Module):                         
    def __init__(self, in_channel):
        ...
        self.conv1 = nn.Linear(in_channel, in_channel // 16, bias=False)
        self.relu = nn.ReLU()
        self.conv2 = nn.Linear(in_channel // 16, in_channel, bias=False)
